...
import { addDays, api, localISODate, money, type Order } from '@bloom/shared'
...
export default function ReportsPage() {
  ...
  const [khqr, setKhqr] = useState(0)

  useEffect(() => {
    void api.reports.range(from, to).then((data) => {
  ...
  for (const o of orders) byCashier.set(o.cashierName, (byCashier.get(o.cashierName) ?? 0) + o.total)
